...
def compare_hashes(hashes1, hashes2):
    ...
    for h in all_keys:
        ...
        if not files1 or not files2:
            mismatches.append((files1 or ['Directory 1 Has No Matches For This File or File Differs From Original'], files2 or ['Directory 2 Has no Matches For This File or File Differs From Original']))
    return mismatches
